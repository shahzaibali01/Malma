        ...
        <div className="main-header">
          <div>
            <div className="header_text_sec">
              <div className="main_classheader">
                ...
                <div className="header_para2">
                  Receive daily reminders, inspirational quotes and data
                  visualizations to better manage gestational diabetes
                </div>
            ...
            <div className="header_btn_sec">
              <button className="header_btn1">View Sample Dashboard</button>

              <button className="header_btn2">Request Early Access</button>
            </div>
          </div>
        </div>
      </div>
